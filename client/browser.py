...
class Browser():
    def __init__(self, start_page_name: str, js_bindings: dict):
        ...
        self.browser = cef.CreateBrowserSync(window_title="Tubes together", url=start_page)
    ...
    def read(self, relpath):
        with open(path.join(path.dirname(__file__), relpath), 'r', encoding='UTF-8') as file:
           return file.read()
